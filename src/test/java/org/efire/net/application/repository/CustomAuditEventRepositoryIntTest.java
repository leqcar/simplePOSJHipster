...
import org.efire.net.application.config.audit.AuditEventConverter;
import org.efire.net.application.domain.PersistentAuditEvent;
...
import static org.efire.net.application.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
